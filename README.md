...
- **Price Trend & "why buy":** every card page draws a **trend chart** of its collected price history with a dashed 30-day projection, plus a plain-language reason for acting — *"The price is trending up — projected +12% in 30 days. Buying now locks in today's price."* Buy Now rows show a compact sparkline too.
